...
from tests.repository.complex.complex_secondary_entities import (
    ...
    ComplexDeleteRequest, ComplexRepository, ComplexCreateDTO, ComplexGetDTO, ComplexListDTO, ComplexUpdateDTO,
    ComplexDeleteDTO,
)
...
class TestComplexRepository(ComplexTestSetup):
    ...
    def test_update_assignments(
            ...
            repository: ComplexRepository,
            course: ComplexCoreModel,
            assignment: AssignmentCoreModel
    ) -> None:
        request: ComplexUpdateRequest = ComplexUpdateRequest(
            id=course.id,
    ...
    def test_create_invalid_department(
            self,
            repository: ComplexRepository
    ) -> None:
        request: ComplexCreateRequest = ComplexCreateRequest(
