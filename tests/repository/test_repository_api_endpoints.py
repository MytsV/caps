...
# from lib.infrastructure.fastapi.fastapi_endpoint import FastAPIBypassEndpoint
# import pytest
...
#         return FastAPIBypassEndpoint(repository=repository, descriptor=descriptor, responses=responses)
#
#     @pytest.fixture
