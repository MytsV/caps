...
from lib.core.endpoint_descriptor import BaseEndpointDescriptor
...
class FastAPICRUDRepositoryEndpoint(ABC, Generic[TBaseDTORequestModel, TBaseViewModel]):
    def __init__(
        self,
        repository: BaseGateway[TBaseDTORequestModel, Any, Any, Any, TBaseViewModel],
